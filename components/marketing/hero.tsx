...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-28 lg:px-8">
          ...
          <div className="relative rounded-3xl border border-white/10 bg-white/5 p-5 shadow-2xl shadow-black/40 backdrop-blur-xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4 transition-transform duration-300 hover:-translate-y-1">
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <span className="text-xs font-medium">Content Planner</span>
                </div>
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4 transition-transform duration-300 hover:-translate-y-1">
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <span className="text-xs font-medium">Article Generator</span>
                </div>
                <p className="mt-2 text-xl font-semibold text-foreground">82%</p>
            ...
            <div className="mt-3 rounded-xl border border-white/10 bg-white/5 p-4">
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span className="text-xs font-medium">Traffic Growth</span>
              </div>
